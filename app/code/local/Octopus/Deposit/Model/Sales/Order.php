 ...
 */
class Octopus_Deposit_Model_Sales_Order extends Mage_Sales_Model_Order
{

    protected function _setState($state, $status = false, $comment = '', $isCustomerNotified = null, $shouldProtectState = false)
    {
		// EDIT: Added by Andy - dispatch an event before we attempt to do anything
		...
		// EDIT: Added by Andy - dispatch an event after status has changed
